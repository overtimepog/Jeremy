...
module.exports = class JeremyClient extends CommandoClient {
	constructor(options) {
		super(options);
		...
		this.webhook = new WebhookClient(Jeremy_WEBHOOK_ID, Jeremy_WEBHOOK_TOKEN, { disableMentions: 'everyone' });
