...
const { Jeremy_GITHUB_REPO_USERNAME, Jeremy_GITHUB_REPO_NAME } = process.env;
const source = Jeremy_GITHUB_REPO_NAME && Jeremy_GITHUB_REPO_USERNAME;
...
module.exports = class InfoCommand extends Command {
	...
	async run(msg) {
		...
		const repoURL = `https://github.com/${Jeremy_GITHUB_REPO_USERNAME}/${Jeremy_GITHUB_REPO_NAME}`;
